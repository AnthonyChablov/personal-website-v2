...
const Contact = () => {
  return (
    <section className="text-center tracking-wide pt-16" id='contact'>
        <Divider className="w-4/12 mx-auto bg-zinc-300 mt-24 mb-24"/>
        <p className="text-lg text-zinc-600">04. What's Next?</p>
        <h4 className="text-4xl font-semibold text-zinc-800 my-5 ">Get In Touch</h4>
        <p className="text-zinc-700  mx-auto text-md mt-8 font-light">
