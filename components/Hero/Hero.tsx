  ...
  return (
    <div className="h-fit text-center mb-24 mt-4 ">
      <m.div
        ...
        variants={width >= 1280 ? heroImgVariants : heroImgMobileVariants}
        initial="hidden"
        animate="visible"
      >
      ...
      <m.p
        className="mt-14 uppercase font-light text-slate-700 text-md dark:text-slate-300"
        variants={
          width >= 1280 ? heroSubHeaderVariants : heroSubHeaderMobileVariants
        }
        initial="hidden"
        animate="visible"
      >
      ...
      <m.h1
        className="mt-9 text-4xl text-slate-800 font-medium dark:text-slate-200"
